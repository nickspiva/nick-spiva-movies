// Credit to wcandillion
// Source https://raw.githubusercontent.com/wcandillon/react-native-redash/v7.5.1/src/Interactable.tsx
        ...
        if (props.gravityPoints) {
            props.gravityPoints.forEach((pt) => {
                ...
                if (pt.damping) {
                    const influenceArea =
                        pt.influenceArea ||
                        influenceAreaWithRadius(1.4 * falloff, pt);
        ...
        const noMovementFrames = {
            ...
            y: new Value(
                props.horizontalOnly
                    ? ANIMATOR_PAUSE_CONSECUTIVE_FRAMES + 1
                    : 0,
            ),
        };
